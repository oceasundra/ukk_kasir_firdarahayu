...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Feb 2024 pada 01.22
...
(2702031959, 'Haechan', 'Korea Selatan', '0882009192645'),
(2702040643, 'Sakuya', 'Jepang', '08975910060'),
(2802025641, 'Jeno', 'Korea Selatan', '0882009192647');
...
(4, '2024-02-27', 470000.00, 2702031959),
(6, '2024-02-27', 170000.00, 2702040643),
(9, '2024-02-28', 450000.00, 2802025641);
...
(4, 'Firda Rahayu', 'petugas', 'afb91ef692fd08c445e8cb1bab2ccf9c', 2);
...
(1, 'ISTJ Album', 150000.00, 123),
(4, 'Fact Check Album', 170000.00, 125),
(5, 'Be There For Me Album', 150000.00, 128);
...
--
ALTER TABLE `pelanggan`
  MODIFY `PelangganID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2802025642;
